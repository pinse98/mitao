...
@section('content')
    <div class="Hui-wraper">
        <div class="responsive">
            <div class="row cl">
                <div class="col-6 left"><h3>Sku小图编辑</h3></div>
        ...
        <form action="" method="post" class="form form-horizontal responsive" id="demoform">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-5">
                    <input type="text" class="input-text" value="{{ $image->name }}" placeholder="小图名称" name="name" datatype="*1-16" nullmsg="名称不能为空">
                </div>
                <div class="col-5"> </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-5">
                    <input type="text" class="input-text" value="{{ $image->image }}" placeholder="小图地址 http://" name="image" datatype="*1-200" nullmsg="小图地址不能为空">
                </div>
                <div class="col-5"> </div>
            </div>
            <div class="row cl">
