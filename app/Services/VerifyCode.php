...
class VerifyCode
{
    const CAPTCHA_ID = '3386e03c620a4067f18fa92c370f1594';

    const PRIVATE_KEY = '5fe89444b54d3a3b8e49594c42a770cf';
    ...
    public function register() {
        $url = "http://api.geetest.com/register.php?gt=" . self::CAPTCHA_ID;
    ...
    public function get_answer($validate) {
        if ($validate) {
            ...
            $challenge = Session::set('challenge');
