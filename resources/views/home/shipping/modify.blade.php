...
@section('content')
    ...
    <div class="address_add mlr20 ">
        <form action="" id="shipform" method="POST">
            ...
            <div class="box box_01">
                ...
                <div class="input">
                    <input type="text" name="name" value="{{ $shipping->name }}" placeholder="请填写真实姓名" id="consignee" maxlength="15">
                </div>
            </div>
            <div class="box box_02">
                ...
                <div class="box_02_01 h_box">
                    <div class="flex_1">
                        <div data-type="select" class="select">
                            <div data-value="0" class="option" id="province">{{ $shipping->province }}</div>
                            <select name="province" id="province_id"></select>
                        </div>
                    </div>
                    <div class="flex_1">
                        <div data-type="select" class="select">
                            <div data-value="0" class="option" id="city">{{ $shipping->city }}</div>
                ...
                <div class="box_02_02">
                    <div data-type="select" class="select">
                        <div data-value="0" class="option" id="district">{{ $shipping->district }}</div>
                        <select name="district" id="district_id"></select>
                    </div>
                </div>
                <div class="box_02_03">
                    <div class="textarea">
                        <textarea name="address" placeholder="路名或街道地址，门牌号，不少于10个字" id="address" maxlength="120">{{ $shipping->address }}</textarea>
                    </div>
                </div>
            </div>
            <div class="box box_03">
                ...
                <div class="input">
                    <input name="zipcode" placeholder="邮政编码,为6位数字" id="zipcode" value="{{ $shipping->zipcode }}" type="tel" maxlength="6">
                </div>
            </div>
            <div class="box box_04">
                ...
                <div class="input">
                    <input name="tel" placeholder="联系人电话，11位数字" id="tel" type="tel" value="{{ $shipping->tel }}" maxlength="11">
                </div>
            </div>
    ...
    <script>
        addressInit('province_id', 'city_id', 'district_id', '{{ $shipping->province }}', '{{ $shipping->city }}', '{{ $shipping->district }}');
