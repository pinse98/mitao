...
@section('content')
    <div class="Hui-wraper">
        <div class="responsive">
            <div class="row cl">
                <div class="col-6 left"><h3>首页排版添加</h3></div>
        ...
        <form action="" method="post" class="form form-horizontal responsive" id="demoform">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-5">
                    <input type="text" class="input-text" name="details" placeholder="商品描述">
                </div>
                <div class="col-5"> </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-5">
                    <input type="text" class="input-text" name="image" placeholder="商品图片">
                </div>
                <div class="col-5"> </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-5">
                    <input type="text" class="input-text" name="level" placeholder="商品排序" datatype="*1-16" nullmsg="排序不能为空" />
                </div>
                <div class="col-5"> </div>
            </div>
