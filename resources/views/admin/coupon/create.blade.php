...
@section('content')
    <div class="Hui-wraper">
        <div class="responsive">
            <div class="row cl">
                <div class="col-6 left"><h3>添加优惠劵</h3></div>
        ...
        <form action="" method="post" class="form form-horizontal responsive" id="demoform">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-5">
                    <input type="text" class="input-text" placeholder="优惠劵名称" name="name" datatype="*1-16" nullmsg="优惠劵名称不能为空">
                </div>
                <div class="col-5"> </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-5">
                    <input type="text" class="input-text" placeholder="优惠金额" name="price" datatype="*1-16" nullmsg="优惠金额不能为空">
                </div>
                <div class="col-5"> </div>
            </div>
            <div class="row cl">
